...
let WBNB_ADDRESS = "0xC76F4c819D820369Fb2d7C1531aB3Bb18e6fE8d8";
let BUSD_WBNB_PAIR = "0x58f876857a02d6762e0101bb5c46a8c1ed44dc16"; // created block 589414
let USDT_WBNB_PAIR = "0xB69A4132af7495aE809Ce0155b7be1889ef72918"; // created block 648115

export function getBnbPriceInUSD(): BigDecimal {
  // fetch eth prices for each stablecoin
  let usdtPair = Pair.load(USDT_WBNB_PAIR); // usdt is token0
  let busdPair = null // Pair.load(BUSD_WBNB_PAIR); // busd is token1
...
let WHITELIST: string[] = [
  ...
  "0x8cC82045E761329FA13C9b0A0a31d76615fEc109", // CFUN
  ...
  "0x5212B42ef96A47Af93F3a6c801227b650EDEb12f", // SKULLZ
];
